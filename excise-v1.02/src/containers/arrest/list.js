                    ...
                    <div className="card">
                        ...
                        <div className="body">
                            <div className="form-group">
                                <div className="form-horizontal">
                                    <div className="row form-group">
                                        <label className="control-label col-lg-1 col-md-1 col-sm-1 col-xs-12" for="txt_search">ค้นหา:</label>
                            ...
                            {/* style="display:none;" */}
                                <div className="form-horizontal">
                                    <div className="row">
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_GuiltBaseName">ข้อกล่าวหา:</label>
                                        <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className="form-control" name="guiltBaseName" id="txt_GuiltBaseName" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-2 col-md-2 col-sm-1 col-xs-12" for="txt_CaseLawID">มาตรา:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className="form-control" name="caseLawID" id="txt_CaseLawID" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_GroupName">สินค้า:</label>
                                        <div className="col-lg-4 col-md-4 col-sm-9 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className="form-control" name="groupName" id="txt_GroupName" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_ProductName">ชื่อสินค้าของกลาง:</label>
                                        ...
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="chb_ExhibitWild"></label>
                                        <div className="col-lg-4 col-md-3 col-sm-9 col-xs-12">
                                            <div className="demo-checkbox">
                                                ...
                                                <label for="chb_ExhibitWild">ของกลางมิชอบด้วยกฏหมาย</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_LawbreakerName">ชื่อผู้กระทำผิด:</label>
                                        <div className="col-lg-4 col-md-4 col-sm-9 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className="form-control" name="lawBreakerName" id="txt_LawbreakerName" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_LawBreakerIDCard">เลขที่บัตรประชาชนผู้กระทำผิด:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-9 col-xs-12">
                                            <div className="form-line">
                                    ...
                                    <div className="row">
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="">วันที่เกิดเหตุ:</label>
                                        <div className="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                            <div className="input-group">
                                                ...
                                                <label for="txt_OccurrenceDate" className="input-group-addon">
                                        ...
                                        <div className="col-lg-2 col-md-2 col-sm-4 col-xs-12 between-item">
                                            <div className="input-group">
                                                ...
                                                <label for="txt_OccurrenceDateTo" className="input-group-addon" id="">
                                                    <i className="material-icons">event</i>
                                                </label>
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_Region">จังหวัด/อำเภอ/ตำบล:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-9 col-xs-12">
                                            <div className="form-line">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-b-0 p-0">
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="">วันที่รับเรื่องส่วนคดี:</label>
                                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div className="input-group">
                                                    <div className="form-line">
                                                    ...
                                                    <label for="txt_TakeDate" className="input-group-addon">
                                                        <i className="material-icons">event</i>
                                                    </label>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 between-item">
                                                <div className="input-group">
                                                    ...
                                                    <label for="txt_TakeDateTo" className="input-group-addon">
                                                        <i className="material-icons">event</i>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-b-0 p-0">
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="">วันที่เขียนบันทึกจับกุม:</label>
                                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <div className="input-group">
                                                    <div className="form-line">
                                                    ...
                                                    <label for="txt_LawSuitDate" className="input-group-addon">
                                                        <i className="material-icons">event</i>
                                                    </label>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 between-item">
                                                <div className="input-group">
                                                    ...
                                                    <label for="txt_LawSuitDateTo" className="input-group-addon">
                                                        <i className="material-icons">event</i>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 clear-m clear-p">
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="txt_LawSuitCode">เลขที่งาน:</label>
                                            ...
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="txt_ExhibitReportNo">รายงานพิสูจน์ที่:</label>
                                            <div className="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                                                <div className="form-line">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 clear-m clear-p">
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="txt_CaseNo">เลขที่คดี:</label>
                                            <div className="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                                                <div className="form-line">
                                                    <input type="text" className=" form-control" name="caseNo" id="txt_CaseNo" />
                                                </div>
                                            </div>
                                            <label className="control-label col-lg-4 col-md-4 col-sm-3 col-xs-12" for="txt_CompareCaseNo">คดีเปรียบเทียบ:</label>
                                            <div className="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                                                <div className="form-line">
                                    ...
                                    <div className="row">
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_Area">สรรพสามิต:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-7 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className=" form-control" name="area" id="txt_Area" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="txt_LawSuitFine">จำนวนเงินค่าปรับ:</label>
                                    ...
                                    <div className="row">
                                        <label className="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="txt_AccuserName">ชื่อผู้กล่าวหา:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-7 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className=" form-control" name="accuserName" id="txt_AccuserName" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="sle_AccuserType">ผู้กล่าวหา:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-7 col-xs-12">
                                    ...
                                    <div className="row">
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="txt_NoticeCode">ค้นหาข้อมูลสีบสวน: เลขที่แจ้งความ</label>
                                        ...
                                        <div className="col-lg-6 col-md-7 col-sm-12 col-xs-12 clear-m clear-p">
                                            <label className="control-label col-lg-5 col-md-4 col-sm-3 col-xs-12" for="chb_IsSentCourt">ลักษณะคดี:</label>
                                            <div className="col-lg-7 col-md-8 col-sm-9 col-xs-12">
                                                <div className="demo-checkbox">
                                                    ...
                                                    <label for="chb_IsSentCourt">ฟ้องศาล</label>
                                                    <input type="checkbox" id="chb_CaseQuality" name="caseQuality" className="filled-in" />
                                                    <label for="chb_CaseQuality">เปรียบเทียบปรับ</label>
                                                    <input type="checkbox" id="chb_HaveCulprit" name="HaveCulprit" className="filled-in" />
                                                    <label for="chb_HaveCulprit">ไม่มีตัว</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="txt_SearchWarrantNo">เลขที่หมายค้น:</label>
                                        <div className="col-lg-2 col-md-2 col-sm-7 col-xs-12">
                                            <div className="form-line">
                                        ...
                                        <div className="col-lg-6 col-md-7 col-sm-12 col-xs-12 clear-m clear-p">
                                            <label className="control-label col-lg-5 col-md-4 col-sm-3 col-xs-12" for="chb_CaseLast1">คดีสิ้นสุด:</label>
                                            <div className="col-lg-7 col-md-8 col-sm-9 col-xs-12">
                                                <div className="demo-checkbox">
                                                    <input type="checkbox" id="chb_CaseLast1" name="caseLast1" className="filled-in" value="1" />
                                                    <label for="chb_CaseLast1">กรมสรรพสามิต</label>
                                                    <input type="checkbox" id="chb_CaseLast2" name="caseLast2" className="filled-in" value="2" />
                                                    <label for="chb_CaseLast2">ศาล</label>
                                                    <input type="checkbox" id="chb_CaseLast3" name="caseLast3" className="filled-in" value="3" />
                                                    <label for="chb_CaseLast3">พนักงานสอบสวน/พนักงานอัยการ</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="txt_ss2_27">เลขที่ ส.ส.2/27:</label>
                                        <div className="col-lg-2 col-md-2 col-sm-7 col-xs-12">
                                            <div className="form-line">
                                                <input type="text" className=" form-control" name="ss2_27" id="txt_ss2_27" />
                                            </div>
                                        </div>
                                        <label className="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12" for="sle_Revoke">เพิกถอน:</label>
                                        <div className="col-lg-3 col-md-3 col-sm-7 col-xs-12">
