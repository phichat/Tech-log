...
let MetisMenu = function ($: any) {
    ...
    MetisMenu = function () {
        MetisMenu = function (element, config) {
        ...
        MetisMenu.prototype.init = function init() {
            ...
            $(this._element)
                ...
                .on(Event.CLICK_DATA_API, function (e) {
                    const _this = $(this);
                    const _parent = _this.parent(self._config.parentTrigger);
                    const _siblings = _parent.siblings(self._config.parentTrigger).children(self._config.triggerElement);
                    const _list = _parent.children(self._config.subMenu);
        ...
        MetisMenu.prototype._show = function _show(element) {
            ...
            if (this._config.toggle) {
                this._hide(_el.parent(this._config.parentTrigger)
                    .siblings()
