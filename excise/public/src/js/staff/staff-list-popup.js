...
function searchFormStaff(e) {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        tr += '<td>' + i + '</td>'
        tr += '<td class="staff-code">xx</td>'
        tr += '<td class="staff-name">xx</td>'
        tr += '<td class="staff-position">xx</td>'
        tr += '<td class="staff-department">xx</td>'
        tr += '<td class="staff-pertype">xx</td>'
        tr += '</tr>'
    }
