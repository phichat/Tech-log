        ...
        return ( 
                ...
                <div className="card">
                    ...
                    <div className="body">
                        <div className="form-horizontal form-group">
                            <div className="row">
                                <label for="sle_isNotice" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">ใบแจ้งความนำจับ:</label>
                            ...
                            <div className="row">
                                <label for="txt_noticeCode" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">เลขที่:</label>
                            ...
                            <div className="row">
                                <label for="txt_noticeName" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">ชื่อผู้แจ้ง:</label>
                            ...
                            <div className="row">
                                <label for="txt_lawsuitCode" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">เลขที่งาน:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="form-line">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-12 col-xs-12 clear-m clear-p">
                                    <label for="" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">วันที่เขียนบันทึกจับกุม:</label>
                            ...
                            <div className="row">
                                <label for="txt_lawsuitLocation" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">เขียนที่:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="form-line">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-12 col-xs-12 clear-m clear-p">
                                    <label for="" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">วันที่เกิดเหตุ:</label>
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div className="input-group">
                                            <div className="form-line">
                                                <input type="text" name="occurenceDate" id="txt_occurenceDate" className="form-control datepicker"/>
                                            </div>
                                            <label for="txt_occurenceDate" className="input-group-addon">
                                                <i className="material-icons">event</i>
                                            </label>
                                        </div>
                                    </div>

                                    <label for="txt_occurenceTime" className="control-label col-lg-1 col-md-1 col-sm-3 col-xs-12">เวลา:</label>
                            ...
                            <div className="row">
                                ...
                                <label for="sle_lawsuitArea" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">พื้นที่:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-12 col-xs-12 clear-m clear-p">
                                    <label for="sle_isLawbreaker" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">ผู้กระทำผิด:</label>
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <div className="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                        <div className="demo-checkbox">
                                            ...
                                            <label for="chb_CaseLast1">ส่งฟ้องศาล</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                    <label for="sle_nmGoodName" className="control-label col-lg-5 col-md-5 col-sm-4 col-xs-12 r-8">สินค้า:</label>
                                    ...
                                    <label for="ul_nmGoodName" className="control-label col-lg-5 col-md-5 col-sm-4 col-xs-12"></label>
                                    <div className="col-lg-7 col-md-7 col-sm-8 col-xs-12 p-l-0 p-r-0">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-6 col-xs-12 clear-m clear-p">
                                    <label for="txt_fine" className="control-label col-lg-4 col-md-4 col-sm-6 col-xs-12">ประมาณการค่าปรับ:</label>
                                    ...
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 clear-m clear-p">
                                        <label for="txt_Staff" className="control-label col-lg-4 col-md-4 col-sm-4 col-xs-12">ชื่อผู้กล่าวหา:</label>
                                        ...
                                        <label for="txt_Position" className="control-label col-lg-4 col-md-4 col-sm-4 col-xs-12">ตำแหน่ง:</label>
                                        <div className="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                            <div className="form-line">
                                        ...
                                        <label for="txt_Department" className="control-label col-lg-4 col-md-4 col-sm-4 col-xs-12">สังกัด:</label>
                                        <div className="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                                            <div className="form-line">
                            ...
                            <div className="row">
                                <label for="txt_locationName" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">สถานที่เกิดเหตุ:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="form-line">
                            ...
                            <div className="row">
                                <label for="txt_address" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">บ้านเลขที่:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="input-group">
                                        <div className="form-line">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-2 col-xs-12 clear-m clear-p">
                                    <label for="txt_building" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">อาคาร/สถานที่:</label>
                            ...
                            <div className="row">
                                <label for="txt_room" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">ห้อง:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="input-group">
                                        <div className="form-line">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-2 col-xs-12  clear-m clear-p">
                                    <label for="txt_alley" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">ตรอก/ซอย:</label>
                                    <div className="col-lg-6 col-md-6 col-sm-4 col-xs-12">
                                        <div className="form-line">
                            ...
                            <div className="row">
                                <label for="txt_road" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">ถนน:</label>
                                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                    <div className="form-line">
                                ...
                                <div className="col-lg-7 col-md-7 col-sm-2 col-xs-12 clear-m clear-p">
                                    <label for="sle_region" className="control-label col-lg-4 col-md-4 col-sm-2 col-xs-12">ตำบล/อำเภอ/จังหวัด:</label>
                                    <div className="col-lg-6 col-md-6 col-sm-4 col-xs-12">
                            ...
                            <div className="row">
                                <label for="txt_localPolishStation" className="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12">สถานีตำรวจท้องที่เกิดเหตุ:</label>
                        ...
                        <div className="row form-group">
                            <div className="row">
                                <label for="" className="control-label col-lg-12 col-md-12 col-sm-12 col-xs-12">ข้อกล่าวหา:</label>
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div className="form-group">
                <div className="card">
                    ...
                    <div className="body">
                        <div className="row">
                            <label for="txta_behaviour" className="control-label col-lg-12 col-md-12 col-sm-3 col-xs-12">พฤติกรรมในการจับ</label>
                        ...
                        <div className="row">
                            <label for="txta_testimony " className="control-label col-lg-12 col-md-12 col-sm-3 col-xs-12">คำให้การของผู้ต้องหา</label>
                            <div className="col-lg-12 col-md-12 col-sm-9 col-xs-12">
                                <div className="form-line">
                        ...
                        <div className="row">
                            <label for="txta_prompt" className="control-label col-lg-12 col-md-12 col-sm-3 col-xs-12">การแจ้งสิทธิ</label>
                            <div className="col-lg-12 col-md-12 col-sm-9 col-xs-12">
                                <div className="form-line">
